...
import com.eazybytes.accounts.constant.AccountConstants;
...
public class AccountsController {
    ...
    @GetMapping("/fetch")
    public ResponseEntity<CustomerDto> fetchAccount(@Pattern(regexp="(^$|[0-9]{10})",
    ...
    public ResponseEntity<ResponseDto> deleteAccount(@Pattern(regexp="(^$|[0-9]{10})",
